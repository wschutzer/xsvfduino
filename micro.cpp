...
void xsvfPrintLenVal( lenVal *plv )
{
    ...
    if ( plv )
    {
        ...
        for ( i = 0; i < plv->len; ++i )
        {
            debug_printf( "%02x", ((unsigned int)(plv->val[ i ])) );
        }
    }
}
#endif  /* DEBUG_MODE */
